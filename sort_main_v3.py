...
if __name__ == "__main__":
    ...
    endungen_exif = {"jpeg": "jpeg", "jpg": "jpeg", "rw2": "raw"}  # -> Media with readable exif files (raw/ Pictures) File extensions from the media files in front as key and the folder to be crated as value

    endungen_created = {"mp4": "mov","mov": "mov"}  # -> Media without readable Exif Files / File extensions from the media files in front as key and the folder to be crated as value

    folder = raw_input("Ordner eingeben: ")
    sort(endungen_exif,endungen_created, folder)
